...
const NavigationV2 = () => {
  ...
  const isExplorer = pathname === '/mar4newdesign';
  const isLookup = pathname === '/disaster-lookup';
  const isCompare = pathname === '/compare';
  const isFactSheet = pathname === '/fact-sheet';
          ...
          >
            ...
            <span className="flex items-center gap-1.5">
              <svg width="14" height="14" viewBox="0 0 16 16" fill="none" className="opacity-60">
                ...
                <path d="M5 5h6M5 8h4M5 11h5" stroke="currentColor" strokeWidth="1" strokeLinecap="round" opacity="0.5"/>
              </svg>
              Fact Sheets
            </span>
          </Link>
